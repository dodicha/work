      ...
      <div key={index} className="m-[10px]">
        <div
          ...
          onClick={() => {
            ...
            console.log(getWatt(machine, data));
            console.log(getOPerationType(machine, "30 Watt", data));
            console.log(
              getMaterials(machine, "30 Watt", "Photo Engraving", data)
            );
            console.log(
              getOptions(machine, "30 Watt", "Photo Engraving", "Acrylic", data)
            );
          }}
        >
          {machine}
